...
from roland_fp30x_controller.midi.ports import list_output_names
...
class MainWindow(QMainWindow):
    def __init__(self) -> None:
        ...
        layout.addWidget(self._build_principal_panel())

        self._lower_panels = QWidget()
        lower_layout = QVBoxLayout(self._lower_panels)
        lower_layout.setContentsMargins(0, 0, 0, 0)
        lower_layout.addWidget(self._build_tone_group())
    ...
    def _retranslate_ui(self) -> None:
        ...
        self._group_principal.setTitle(self._tr("group_main"))
        ...
        self._group_tone.setTitle(self._tr("group_tone"))
    ...
    def _build_principal_panel(self) -> QWidget:
        self._group_principal = QGroupBox()
        v = QVBoxLayout(self._group_principal)
    ...
    def _build_tone_group(self) -> QWidget:
        self._group_tone = QGroupBox()
        v = QVBoxLayout(self._group_tone)
    ...
    def _refresh_ports(self) -> None:
        ...
        self._port_combo.addItems(names)
        if current in names:
            self._port_combo.setCurrentText(current)
        self._set_status(self._tr("status_output_ports", n=len(names)))
    ...
    def _toggle_connect(self) -> None:
        ...
        self._reapply_full_part_to_device(latch_after_program=False)
    ...
    def _reapply_full_part_to_device(
        self, *, latch_after_program: bool = True
    ) -> None:
        if not self._midi.is_open:
            return
